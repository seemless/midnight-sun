...
import { parseResume, resetIdCounter, extractEmail, extractPhone, extractLinkedInUrl, extractGithubUrl, parseNameLine, parseSkills, splitSections, splitEntries, } from "../../src/shared/parser";
beforeEach(() => {
    resetIdCounter();
});
...
describe("extractEmail", () => {
    it("finds email in text", () => {
        expect(extractEmail("Contact: connor@roblox.com or call")).toBe("connor@roblox.com");
    });
    it("handles plus addressing", () => {
        expect(extractEmail("connor+jobs@gmail.com")).toBe("connor+jobs@gmail.com");
    });
...
describe("extractLinkedInUrl", () => {
    it("finds LinkedIn URL", () => {
        expect(extractLinkedInUrl("linkedin.com/in/connor")).toBe("linkedin.com/in/connor");
    });
    it("finds full URL", () => {
        expect(extractLinkedInUrl("https://www.linkedin.com/in/connor")).toBe("https://www.linkedin.com/in/connor");
    });
});
