...
import { createMemoryStorage, setStorageAdapter, createFillRun, saveFillRun, getFillRuns, } from "../../src/shared/storage";
beforeEach(() => {
...
describe("createFillRun", () => {
    ...
    it("preserves structured signals for debugging", () => {
        ...
        const firstNameField = run.detectedFields.find((f) => f.matchedField === "firstName");
